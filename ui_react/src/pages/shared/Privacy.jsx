    ...
    return (
      <div className="p-4">
        ...
        <header className="relative mb-4">
          <nav className="border border-gray-300 p-4">
            <ul className="flex items-center">
              ...
              <li><a href="/Feature" className="px-4 py-2">Blog</a></li>
              <li><a href="/Homes" className="px-4 py-2">Photos</a></li>
              <li><a href="/Faq" className="px-4 py-2">My Trips</a></li>
            </ul>
          </nav>
        </header>
        ...
        <footer className="relative mt-4 border border-gray-300 p-4">
          <p><a href="/Contact" className="mr-2">Contact Us</a> | <a href="#" className="mx-2">Sitemap</a> | <a href="/Privacy" className="ml-2">Privacy Policy</a></p>
          <p className="mt-2">&copy;2024 Copyright @ Good Job</p>
        </footer>
      </div>
    );
  }
