    ...
    return (
        <div className="bg-gray-200 font-sans leading-normal tracking-normal">
            ...
            <div className="container px-4 md:px-0 max-w-6xl mx-auto -mt-32">
                <div className="mx-0 sm:mx-6">
                    ...
                    <nav className="mt-0 w-full">
                        <div className="container mx-auto flex items-center">
                            {/* Navigation links */}
                            {/* You can convert this part into a separate Navigation component */}
                            ...
                            {/* Social media links */}
                            {/* You can convert this part into a separate SocialLinks component */}
                    ...
                    {/* Post Content */}
                    {/* You can convert the entire post content section into a separate component */}
                    {/* Lead Card */}
                    <div className="flex h-full bg-white rounded overflow-hidden shadow-lg">
                        <a href="post.html" className="flex flex-wrap no-underline hover:no-underline">
                            <div className="w-full md:w-2/3 rounded-t"> 
                                <img src="https://source.unsplash.com/collection/494263/800x600" className="h-full w-full shadow" alt="Lead Card Image" />
                            </div>
                            <div className="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
                                <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                                    ...
                                    <p className="text-gray-800 font-serif text-base px-6 mb-5">
                                        This starter template is an attempt to replicate the default Ghost theme using Tailwind CSS and vanilla Javascript.
                                    </p>
                                </div>
                    ...
                    {/* /Lead Card */}
                    {/* Other Posts */}
                    {/* You can map through an array of post data and render each post dynamically */}
                    {/* For simplicity, I'm just translating one post */}
                    <div className="flex flex-wrap justify-between pt-12 -mx-6">
                        {/* 1/3 col */}
                        <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                                <a href="#" className="flex flex-wrap no-underline hover:no-underline">
                                    <img src="https://source.unsplash.com/collection/225/800x600" className="h-64 w-full rounded-t pb-6" alt="Post Image" />
                        ...
                        {/* Repeat the above structure for other posts */}
                    </div>
                    {/* /Post Content */}
                </div>
                {/* Subscribe */}
                {/* You can convert the subscribe section into a separate Subscribe component */}
                ...
                {/* /Subscribe */}
                {/* Author */}
                {/* You can convert the author section into a separate Author component */}
                <div className="flex w-full items-center font-sans p-8 md:p-24">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-600 text-xs md:text-base">Tailwind CSS version of Ghosts Casper theme by <a className="text-gray-800 hover:text-green-500 no-underline border-b-2 border-green-500" href="https://www.tailwindtoolbox.com">TailwindToolbox.com</a></p>
                    </div>
            ...
            {/* Footer */}
            {/* You can convert the footer section into a separate Footer component */}
